"""Environment application for the Linux subsystem.

Reads the persisted Linux subsystem state (see :mod:`hermes_android.linux.state`)
and translates it into the process environment variables consumed by the
terminal/execute_code tool backends.
"""
